...
@Import({Lab1Controller.class, WeatherServiceImpl.class})
class Lab1ControllerTest {
    ...
    private static final double baseline = 1.08E8;

    @BeforeEach
    void setUp() {
        when(darkskyClient.get(anyString())).thenReturn(just(darkskyResponse).delayElement(ofMillis(100)));
    }

    @Test
    void test() {
        var duration = averageDuration(10);
