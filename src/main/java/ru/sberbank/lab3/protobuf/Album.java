...
public class Album {
    ...
    public Album makeSampleAlbum() {
        List<String> artist = new ArrayList<>(Collections.singletonList("Tears For Fears"));
        ...
        return new Album("Songs from the Big Chair", artist, 1985, songTitles);
    }
