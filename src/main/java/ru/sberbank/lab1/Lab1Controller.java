...
public class Lab1Controller {
    ...
    CachingProxy cachingProxy = new CachingProxy(this);
    ...
    public List<Double> getTemperatureForLastDays(int days) throws JSONException {
        ...
        for (int i = 0; i < days; i++) {
            ...
            //Добавила кэширующий прокси
            Double dayTemperature = cachingProxy.getDayTemperature(curDateSec);
            temps.add(dayTemperature);
        }
        return temps;
    }
}
