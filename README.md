...
Видим, что в целом ощутимое ускорение было от многопоточности, а вот остальным оптимизация надо бы провести стат тест, но число вызовов апи у нас общее, кажется они тоже помогли
